            ...
            <table class="table table-bordered">
                <div class="panel-body">
                    ...
                    <select name="select1">
                        ...
                        <option value="3" selected="selected">补签</option>
                    </select>
                </div>
                <div class="panel-body">
                    <input name="qjLx" type="text"/>请假类型<br/>
                    <input name="days" type="text"/>请假天数<br/>
                    <input name="qjShichang" type="text"/>请假时长<br/>
                    <input name="qjBeizhu" type="text"/>请假备注<br/>
                    <input type="submit"/>
                </div>
            </table>
        </form>
